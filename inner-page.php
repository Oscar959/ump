    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="appropos.php">A propos de nous</a></li>
          ...
          <li class="dropdown"><a href="#"><span>Organisations</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li class="dropdown"><a href="#"><span>Oraganisation 2</a>
              </li>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
            <h3>UNION DES MEDECINS POUR LA POPULATION</h3>
            <p>Nous avons appris et accompli plusieures taches notamment : le classement et l’enregistrement des certains documents, la statistiques des décès des agents.
              Envie de trouver la solution aux problèmes éprouvés par la direction des affaires sociales de l’Unikin , nous souhaitons que les autorités compétentes répondent aux demandes et préoccupations soumises par les agents de cette direction enfin de doter a ce bureau les matériels adéquats pour son bon fonctionnement.
              .</p>
