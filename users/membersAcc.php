			...
			if($query1){
			  ...
			  $output= '<script>
						    alert("Cà n\'a pas marché");
						    setTimeout(function(){
						     window.location.replace("register_users.php");
							},1000);</script>';
			...
			$output= '<script>
						    alert("Aucune donnée introduite reesayez");
						    setTimeout(function(){
						     window.location.replace("register_users.php");
							},1000);</script>';
