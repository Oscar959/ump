        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-primary" id="exampleModalLabel">Repondez au commentaire</h5>
                ...
                <div class="modal-body text-primary">
				  <div class="row">
				   <div class="col-lg-12">
						   <div class="alert alert-info  alert-dismissable col-lg-8" style="display: none">
							<button type="button" class="close">×</button>
							<h4>Reussie</h4> 
							<p style="text-align:justify">Votre message est énvoyé avec success, Les admnistrateurs 
							tiendront votre point de vue en haute éstime, vous serez rappelé de maniére individuelle s'il le faut. merci!</p>
						   </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"
                                    role="button" aria-expanded="true" aria-controls="collapseCardExample">
                                    <h6 class="m-0 font-weight-bold text-primary" style="font-style:italic">Repondez au commentaire</h6>
                                </a>
                                <!-- Card Content - Collapse -->
                                        ...
                                        <form  id="form">
										  <div class="row">
											  <div class="col-md-12 form-group ">
												...
												<textarea class="form-control" name="message" id="message" rows="3" placeholder="Votre reponse"></textarea>
											  </div>
											  
										  </div>
										  <div class="text-center" style="margin:1rem;"><button type="submit" id="sent" name="sent" class="btn btn-primary" style="font-style:italic">envoyer</button></div>
                                      </form>
                                    </div>
                                </div>
                            </div>
