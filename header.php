...
<head>
 ...
 <link
  ...
  <link href="assets/css/style_New1.css" rel="stylesheet">
  ...
  *{
   ...
   h1, h2, h3,h4,h5,h6, p, small, li, strong, a, {
	    font-family: 'Nunito', sans-serif;
   }
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="service.php">Objectifs</a></li>
          <li><a class="nav-link scrollto" href="docteur.php">Docteur</a></li>
		  <li><a class="nav-link scrollto" href="activites.php">Activités</a></li>
